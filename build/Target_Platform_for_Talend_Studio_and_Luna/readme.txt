1) open the .target in eclipse 44 using the Target Editor (Plug-in Development).
2) export it to some TargetPlatformE44/ (Export button in Target Editor, top right corner)
